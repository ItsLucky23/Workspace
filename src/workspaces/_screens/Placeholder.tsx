  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      ...
      <div className="flex-1 min-h-0 flex items-center justify-center">
        <EmptyState icon={icon} title={translate({ key: 'workspaces.placeholder.comingNext', params: [{ key: 'title', value: title }] })} sub={translate({ key: 'workspaces.placeholder.buildListSub' })} />
      </div>
    </div>
  );
}
